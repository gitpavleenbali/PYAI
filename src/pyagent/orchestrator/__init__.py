"""
PyAgent Orchestrator - Advanced Multi-Agent Scheduling & Coordination
=====================================================================
...
Examples:
    >>> from pyagent.orchestrator import Orchestrator, workflow
...
{review_prompt or "Review and synthesize these results into a final output."}"""
    ...
    def debate(
        ...
        *,
        ...
        if judge_agent:
            verdict = judge_agent(f"Judge this debate:\n\n{full_transcript}\n\nWho made better arguments and why?")
