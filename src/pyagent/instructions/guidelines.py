...
class StandardGuidelines:
    ...
    def safety() -> Guidelines:
        ...
        return (Guidelines(name="Safety Guidelines")
    ...
    def accuracy() -> Guidelines:
        ...
        return (Guidelines(name="Accuracy Guidelines")
    ...
    def coding() -> Guidelines:
        ...
        return (Guidelines(name="Coding Guidelines")
    ...
    def communication() -> Guidelines:
        ...
        return (Guidelines(name="Communication Guidelines")
