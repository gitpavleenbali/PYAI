"""
openstackai Configuration - Zero-config by default, customizable when needed
...
@dataclass
class pyaiConfig:
    """Global configuration for openstackai."""
...
def configure(
    ...
    **kwargs,
    ...
    """
    Configure openstackai globally. All parameters are optional.
...
class ConfigAccessor:
    ...
    def configure(self, **kwargs):
        """Configure openstackai settings."""
        configure(**kwargs)
...
def with_config(**kwargs):
    ...
    Example:
        >>> with openstackai.with_config(temperature=0.0):
