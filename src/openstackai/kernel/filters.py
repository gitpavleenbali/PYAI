...
class Filter(ABC):
    ...
    def on_function_invoking(
        self, context: FilterContext, arguments: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def on_function_invoked(self, context: FilterContext, result: Any) -> Any:
...
class PromptFilter(Filter):
    ...
    def on_prompt_rendering(self, context: FilterContext, prompt: str) -> str:
    ...
    def on_prompt_rendered(self, context: FilterContext, prompt: str, result: str) -> str:
...
class FilterRegistry:
    ...
    def get_filters(self, filter_type: Optional[FilterType] = None) -> List[Filter]:
    ...
    def apply_function_invoked(self, context: FilterContext, result: Any) -> Any:
    ...
    def apply_prompt_rendering(self, context: FilterContext, prompt: str) -> str:
    ...
    def apply_prompt_rendered(self, context: FilterContext, prompt: str, result: str) -> str:
