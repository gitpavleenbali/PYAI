...
from openstackai.core.base import BaseComponent, Executable
...
class Skill(BaseComponent, Executable, ABC):
    ...
    def add_parameter(
        self, name: str, description: str, type: str = "string", required: bool = True, **kwargs
    ) -> "Skill":
        """Add a parameter to the skill"""
        param = SkillParameter(
            name=name, description=description, type=type, required=required, **kwargs
        )
