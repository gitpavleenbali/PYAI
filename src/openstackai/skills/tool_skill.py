...
from openstackai.skills.skill import Skill, SkillParameter, SkillResult


def tool(name: Optional[str] = None, description: Optional[str] = None, **kwargs) -> Callable:
    """
    ...
    def decorator(func: Callable) -> "ToolSkill":
        skill = ToolSkill.from_function(func, name=name, description=description, **kwargs)
...
class ToolSkill(Skill):
    ...
    @classmethod
    def from_function(
        cls, func: Callable, name: Optional[str] = None, description: Optional[str] = None, **kwargs
    ) -> "ToolSkill":
...
class ToolRegistry:
    ...
    def register(
        self, func: Optional[Callable] = None, name: Optional[str] = None, **kwargs
    ) -> Callable:
