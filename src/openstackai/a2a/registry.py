...
class AgentRegistry:
    ...
    def register(self, url: str, card: Optional[AgentCard] = None, **metadata) -> RegisteredAgent:
        """Register an agent.
    ...
    def find_by_name(self, name: str) -> List[RegisteredAgent]:
        ...
        with self._lock:
            ...
            return [a for a in self._agents.values() if name_lower in a.card.name.lower()]
    ...
    def discover_from_env(self, env_var: str = "pyai_AGENTS") -> int:
...
def register_agent(url: str, **metadata) -> RegisteredAgent:
