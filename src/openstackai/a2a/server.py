...
from .protocol import A2AResponse, A2ATask, AgentCard
...
class A2AEndpoint:
    ...
    def __init__(
        ...
        Args:
            ...
            agent: openstackai Agent instance
