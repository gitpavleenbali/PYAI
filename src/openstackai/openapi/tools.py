...
from .parser import OpenAPIOperation, OpenAPISpec, parse_openapi
...
def _create_tool_from_operation(
    operation: OpenAPIOperation, client: OpenAPIClient
) -> Dict[str, Any]:
...
class OpenAPITools:
    ...
    def __init__(
        ...
        self._handlers = {t["function"]["name"]: t["handler"] for t in self._tools}
