...
class MultimodalContent:
    ...
    def add_image(
        self, image: Union[Image, str], detail: str = "auto", **metadata
    ) -> "MultimodalContent":
        """Add image content.
    ...
    def add_audio(self, audio: Union[Audio, str], **metadata) -> "MultimodalContent":
        """Add audio content.
    ...
    def add_video(
        self, video: Union[Video, str], extract_frames: int = 0, **metadata
    ) -> "MultimodalContent":
        """Add video content.
    ...
    def get_text(self) -> str:
        ...
        texts = [part.content for part in self.parts if part.type == "text"]
        return " ".join(texts)

    def get_images(self) -> List[Image]:
        """Get all image parts."""
        return [part.content for part in self.parts if part.type == "image"]
