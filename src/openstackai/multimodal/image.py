...
class Image:
    ...
    @classmethod
    def from_url(cls, url: str, detail: str = "auto", **metadata) -> "Image":
    ...
    @classmethod
    def from_file(cls, path: Union[str, Path], detail: str = "auto", **metadata) -> "Image":
    ...
    @classmethod
    def from_base64(
        cls, data: str, media_type: str = "image/png", detail: str = "auto", **metadata
    ) -> "Image":
    ...
    @classmethod
    def from_bytes(
        cls, data: bytes, media_type: str = "image/png", detail: str = "auto", **metadata
    ) -> "Image":
    ...
    @classmethod
    def from_pil(cls, image: Any, format: str = "PNG", detail: str = "auto", **metadata) -> "Image":
...
def load_image(source: Union[str, Path, bytes], detail: str = "auto", **metadata) -> Image:
