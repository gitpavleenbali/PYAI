"""
Vector Database Connectors for openstackai
=======================================

Unified interface to connect openstackai RAG operations with popular vector databases.
...
class AzureAISearchStore(VectorStore):
    ...
    def __init__(
        ...
        self.index_name = index_name or os.environ.get("AZURE_SEARCH_INDEX", "openstackai-docs")
