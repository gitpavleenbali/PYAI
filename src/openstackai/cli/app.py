...
"""
openstackai CLI Interactive App
...
class CLIApp:
    ...
    Example:
        from openstackai.cli import CLIApp
    ...
    def __init__(self, agent: Any, name: str = "openstackai", welcome_message: str = None):
        """Initialize CLI app.
...
def run_cli(agent: Any, **kwargs):
    ...
    Example:
        from openstackai.cli import run_cli
        from openstackai import Agent
