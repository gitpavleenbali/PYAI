...
class WeaviateStore(VectorStore):
    ...
    def _get_client(self):
        ...
        self._client = weaviate.Client(
            url=self._url, auth_client_secret=auth_config, **self._kwargs
        )
    ...
    def _find_by_doc_id(self, doc_id: str) -> Optional[str]:
        ...
        result = (
            client.query.get(self._class_name, ["doc_id"])
            .with_where(
                {
                    "path": ["doc_id"],
                    "operator": "Equal",
    ...
    def search(
        ...
        if self._embedding_function:
            ...
            query_builder = client.query.get(
                self._class_name, ["content", "doc_id", "metadata_json"]
        ...
        query_builder = query_builder.with_additional(["certainty", "distance"]).with_limit(k)
