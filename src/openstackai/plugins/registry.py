...
class PluginRegistry:
    ...
    def get_function(self, plugin_name: str, function_name: str) -> Optional[PluginFunction]:
    ...
    def call(self, plugin_name: str, function_name: str, *args, **kwargs) -> Any:
...
def call_function(plugin_name: str, function_name: str, *args, **kwargs) -> Any:
