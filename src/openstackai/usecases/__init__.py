"""
openstackai Use Cases - Pre-built Agent Templates
==============================================
...
Usage:
    >>> from openstackai.usecases import customer_service, sales
...
- Refunds over 60 days: Manager approval needed"""
    ...
    def create_support_workflow(*, tiers: int = 2):
        ...
        from openstackai.orchestrator import ExecutionPattern, Orchestrator, Task, Workflow
