...
from openstackai.core.llm import LLMConfig, ModelProvider
...
class AgentBlueprint(BaseComponent):
    ...
    def build(self) -> "Agent":
        ...
        """
        from openstackai.core.agent import Agent, AgentConfig
        from openstackai.instructions import SystemPrompt
        from openstackai.instructions.persona import PERSONAS, get_persona
        from openstackai.skills.registry import get_default_registry
    ...
    def _create_llm_provider(self, config: LLMConfig):
        ...
        from openstackai.core.llm import AnthropicProvider, AzureOpenAIProvider, OpenAIProvider
