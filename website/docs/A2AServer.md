...
|-----------|------|---------|-------------|
| `agent` | `Agent` | `None` | openstackai Agent instance |
...
```python
from openstackai.a2a import A2AEndpoint, A2AServer, A2ATask, A2AResponse
...
```python
from openstackai.a2a import A2AEndpoint, A2AServer
