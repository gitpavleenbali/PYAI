...
All notable changes to openstackai will be documented in this file.
...
This is the first public release of openstackai, the revolutionary AI library that makes complex AI tasks as simple as pandas operations.
