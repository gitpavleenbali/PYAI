...
class TestVoiceSmoke:
    ...
    def test_duplex_stream(self):
        ...
        from openstackai.voice.stream import DuplexAudioStream, AudioChunk
...
class TestA2ASmoke:
    ...
    def test_agent_card_serialization(self):
        ...
        from openstackai.a2a.protocol import AgentCard
    ...
    def test_a2a_task_creation(self):
        ...
        from openstackai.a2a.protocol import A2ATask
    ...
    def test_a2a_response_success(self):
        ...
        from openstackai.a2a.protocol import A2AResponse, TaskStatus
    ...
    def test_a2a_endpoint_registration(self):
        ...
        from openstackai.a2a.server import A2AEndpoint
    ...
    def test_a2a_server_instantiation(self):
        ...
        from openstackai.a2a.server import A2AServer
        from openstackai.a2a.protocol import AgentCard
    ...
    def test_agent_registry_singleton(self):
        ...
        from openstackai.a2a.registry import AgentRegistry
    ...
    def test_remote_agent_wrapper(self):
        ...
        from openstackai.a2a.client import RemoteAgent
...
class TestDevUISmoke:
    ...
    def test_devui_instantiation(self):
        ...
        from openstackai.devui.ui import DevUI
    ...
    def test_dashboard_metrics_tracking(self):
        ...
        from openstackai.devui.dashboard import AgentDashboard
    ...
    def test_debugger_breakpoints(self):
        ...
        from openstackai.devui.debugger import AgentDebugger
...
class TestToolDiscoverySmoke:
    ...
    def test_tool_decorator_chain(self):
        ...
        from openstackai.tools import tool, Tool
