...
class TestPluginFunction:
    ...
    def test_plugin_function_import(self):
        ...
        from openstackai.plugins import PluginFunction
    ...
    def test_plugin_function_from_function(self):
        ...
        from openstackai.plugins.base import PluginFunction
...
class TestPlugin:
    ...
    def test_plugin_creation(self):
        ...
        from openstackai.plugins import Plugin
        from openstackai.plugins.decorators import function
...
class TestPluginFromFunctions:
    ...
    def test_plugin_from_functions(self):
        ...
        from openstackai.plugins.base import PluginFromFunctions
...
class TestDecorators:
    ...
    def test_plugin_decorator(self):
        ...
        from openstackai.plugins.decorators import plugin
        from openstackai.plugins import Plugin
...
class TestPluginIntegration:
    ...
    def test_module_exports(self):
        ...
        from openstackai import plugins
    ...
    def test_main_init_exports(self):
        """Test that plugins is exported from main openstackai."""
        import openstackai
        
        assert hasattr(openstackai, "plugins")
        assert hasattr(openstackai, "Plugin")
        assert hasattr(openstackai, "PluginRegistry")
    
    def test_full_plugin_workflow(self):
        """Test complete plugin workflow."""
        from openstackai.plugins import Plugin, PluginRegistry
        from openstackai.plugins.decorators import function, plugin
