...
"""openstackai Core Module Unit Tests
==============================
...
class TestAgentFactory:
    ...
    def test_import_simple_agent_class(self):
        ...
        from openstackai.easy.agent_factory import SimpleAgent
...
class TestLLMInterface:
    ...
    def test_import_llm_interface(self):
        ...
        from openstackai.easy.llm_interface import LLMInterface
...
class TestConfig:
    ...
    def test_import_configure(self):
        ...
        from openstackai.easy.config import configure
        assert configure is not None
        assert callable(configure)
    
    def test_import_get_config(self):
        """Test importing get_config function."""
        from openstackai.easy.config import get_config
    ...
    def test_configure_sets_values(self):
        ...
        from openstackai.easy.config import configure, get_config, reset_config
    ...
    def test_config_set_model(self):
        ...
        from openstackai.easy.config import config, get_config, reset_config
    ...
    def test_config_enable_mock(self):
        ...
        from openstackai.easy.config import config, is_mock_enabled, reset_config
...
class TestInstructions:
    ...
    def test_import_instruction(self):
        ...
        from openstackai.instructions import Instruction
    ...
    def test_import_context(self):
        ...
        from openstackai.instructions import Context
        assert Context is not None
    
    def test_import_persona(self):
        """Test importing Persona."""
        from openstackai.instructions import Persona
        assert Persona is not None
    
    def test_import_guidelines(self):
        """Test importing Guidelines."""
        from openstackai.instructions import Guidelines
...
class TestBlueprint:
    ...
    def test_import_blueprint(self):
        ...
        from openstackai.blueprint import Blueprint
    ...
    def test_import_pipeline(self):
        ...
        from openstackai.blueprint import Pipeline
