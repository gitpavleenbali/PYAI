"""
Vector Database Connectors for PyAgent
=======================================

Unified interface to connect PyAgent RAG operations with popular vector databases.
...
class AzureAISearchStore(VectorStore):
    ...
    def __init__(
        ...
        self.index_name = index_name or os.environ.get("AZURE_SEARCH_INDEX", "pyagent-docs")
...
class ChromaStore(VectorStore):
    ...
    def __init__(
        ...
        collection_name: str = "pyagent_docs"
    ):
        self.path = path
