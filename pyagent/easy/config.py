"""
PyAgent Configuration - Zero-config by default, customizable when needed
...
class PyAgentConfig:
    ...
    def get_api_key(self) -> str:
        ...
        if not api_key:
            ...
            api_key = os.environ.get("PYAGENT_API_KEY")
...
def configure(
    ...
    **kwargs
    ...
    """
    Configure pyagent globally. All parameters are optional.
...
def with_config(**kwargs):
    ...
    Example:
        >>> with pyagent.with_config(temperature=0.0):
